...
export type ParticipantProps = FormBaseProps<Participant, { churches: Church[]; specialties: MediaSpecialty[] }, "participant_id">;
...
export type ParticipantTrainingDetailProps = FormBaseProps<ParticipantTrainingDetail, { participants: Participant[] }, "detail_id">;